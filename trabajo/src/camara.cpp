...
void Camara3Modos::desplRotarXY( const float da, const float db )
{
   switch( modo_actual )
   {
      case ModoCam::examinar :
      {
         ...
         // .....
         org_polares = org_polares + Tupla3f({da/50.0,db/50.0,0.0});
      ...
      case ModoCam::prim_pers_rot :
      {
         ...
         Tupla3f cartesianas_antiguas= org_cartesianas;
         org_cartesianas=Cartesianas(org_polares);

         Tupla3f vector_desplazamiento=org_cartesianas-cartesianas_antiguas;
         punto_atencion=punto_atencion-vector_desplazamiento;
         actualizarEjesMCV();
...
void Camara3Modos::moverZ( const float dz )
{
   ...
   switch( modo_actual )
   {
      ...
      case ModoCam::prim_pers_despl :
      {
         ...
         // nota: los ejes no cambian
         // .....
         punto_atencion = punto_atencion + Tupla3f({0.0,0.0,dz/50.0});
