...
class MallaRevolParam :public MallaInd
{
   private:
   double angulo=0;
   ...
   MallaRevolParam() {} // solo usable desde clases derivadas con constructores especificos
...
class SemiCono : public MallaRevol{
   public:
      SemiCono(const int num_verts_per, const unsigned nperfiles, const int n);

};

class CilindroParam : public MallaRevolParam{
   public:
      CilindroParam(const int num_verts_per, const unsigned nperfiles, double angulo);
